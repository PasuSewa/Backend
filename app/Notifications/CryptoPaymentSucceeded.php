...
class CryptoPaymentSucceeded extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject(__('notifications.payments.crypto.success_subject'))
            ->greeting(__('notifications.greeting'))
            ->line(__('notifications.anti_fishing') . $this->anti_fishing_secret)
            ->line(__('notifications.payments.crypto.success_body'))
